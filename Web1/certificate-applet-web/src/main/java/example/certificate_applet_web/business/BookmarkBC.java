package example.certificate_applet_web.business;

import java.util.List;

import example.certificate_applet_web.entity.Bookmark;
import example.certificate_applet_web.persistence.BookmarkDAO;
